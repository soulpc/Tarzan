...
BOT_TOKEN = environ.get('BOT_TOKEN', '5288373674:AAFq1O6nB_SP39_Xoj6vz5z3AOf7NBBc7Gg')
# Bot settings
...
AI_LOGS = int(environ.get("AI_LOGS","1002276401285")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of Bot ]
